...
// import 'package:solvequery/logout.dart';
// import 'package:solvequery/screens/email_auth/login.dart';
...
// static Future<void> logoutAlert(BuildContext context, String text) async {
//     return showDialog(
//       context: context,
...
//               fontSize: 16,
//               color: Color.fromARGB(255, 122, 91, 0),
//             ),
//           ),
//           actions: [
//             Row(
...
//                     textStyle: const TextStyle(color: Colors.black,fontSize: 22,fontWeight: FontWeight.w400),
//                     borderRadius: 12,
...
//                   height: 20,
//                 ),
//                 ElevatedButton(onPressed: (){logoutAlert(context, "Confirm for going logout");}, child: Text("Logout"))
//               ],
//             ),
//           ),
//         ),
